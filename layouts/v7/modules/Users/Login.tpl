        ...
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/dress1.jpg">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/dress2.jpg">
                                </div>
                            </li><li>
                                <div id="slide2" class="slide">
                                    <img class="pull-left" src="test/logo/dress3.jpg">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">Euro Mode Donner CRM</h1>
                    <p>Manage your clients and orders easily!</p>
                </div>
